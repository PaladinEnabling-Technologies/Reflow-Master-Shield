...
//#define GLCDCFG_GLCDCONFIG "config/ks0108/AutoConfig_ks0108-128x64_Panel.h"                        // Default Active configuration.
...
#define GLCDCFG_GLCDCONFIG "config/ks0108/ManualConfig_ks0108_Panel.h"                                // We're activating this configuration so that all boards will use the Arduino UNO pin configuration.
